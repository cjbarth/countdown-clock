...
export class Clock {
    ...
    drawColorWedge(arcRadians, fillColor, outlineColor) {
        ...
        this.ctx.arc(this.options.hMidpoint, this.options.vMidpoint, this.options.clockRadius, -(Math.TAU / 4), arcRadians - (Math.TAU / 4));
    ...
    renderFrame(frameNumber) {
        ...
        this.clear();
        this.drawColorWedge(arcRadians, this.options.arcFillColor + this.options.arcFillTransparency, this.options.arcOutlineColor + this.options.arcOutlineTransparency);
        this.drawEdge();
