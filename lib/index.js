...
const getOptions = () => {
    ...
    const options = {
        ...
        tickLabels: (_b = (_a = $("#tickLabels")
            .val()) === null || _a === void 0 ? void 0 : _a.toString().split(";").map((s) => s.trim())) !== null && _b !== void 0 ? _b : [],
...
getDownloadButton().addEventListener("click", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield transcoder.addAudio(myClock.options.backgroundAudio);
    for (let frame = 0; frame <= myClock.frameCount; frame++) {
        myClock.renderFrame(frame);
    ...
    const video = yield transcoder.transcode(myClock.options.countdownSeconds, !!myClock.options.backgroundAudio, (status) => {
        console.log(status);
    });
